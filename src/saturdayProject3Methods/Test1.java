package saturdayProject3Methods;
...
public class Test1 {
    ...
    @Test
    public void AdditionSquareOfNumbers1() {

        AdditionSquareOfNumbers s1 = new AdditionSquareOfNumbers();
    ...
    @Test
    public void AdditionSquareOfNumbers2() {
    ...
    public void CamelCase2() {
        ...
        Assert.assertTrue("result should be --> Say That An Element In <--but your result is " + result, result.equals("Say That An Element In"));
