...
//
//
//        // String username and string last name print it in the one Line
        String name = "Oguz";
        String lastName = "Atay";
        System.out.println(name + " " + lastName);
//
//
//        System.out.println("Favorite Author? ");
//        byte favAuthor = s1.nextByte();
//        System.out.println("answer for the favorite author " + favAuthor);
